...
scd = SCD(nrows=args.nrows, nfeatures=args.nfeatures, w_inc1=args.w_inc1,
          w_inc2=args.w_inc2, tol=0.000001, local_iter=100,
          num_iters=args.num_iters, updated_features=args.updated_features,
          round=args.round, hidden_nodes=args.hidden_nodes,
          interval=args.interval, n_jobs=args.n_jobs, num_gpus=args.num_gpus,
          adaptive_inc=False, verbose=verbose)
