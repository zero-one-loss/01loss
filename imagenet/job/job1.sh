...
--n-jobs 2 --num-gpus 2 --target imagenet_scd_v15_075.pkl

python train_scd_hl.py --nrows 0.75 --nfeatures 1 --w-inc1 0.17 --w-inc2 0.2 \
--num-iters 1000 --hidden-nodes 20 --updated-features 128 --round 100 --interval 10 \
